...
describe('mapDefinitions/MapDefinitionSerializer', () => {
  describe('XML to XML', () => {
    ...
    describe('generateMapDefinitionBody', () => {
      ...
      it('Generates body with v2 loop', () => {
        const sourceNode = extendedSourceSchema.schemaTreeRoot.children.find((child) => child.name === 'Looping') as SchemaNodeExtended;
        const targetNode = extendedTargetSchema.schemaTreeRoot.children.find((child) => child.name === 'Looping') as SchemaNodeExtended;
        const mapDefinition: MapDefinitionEntry = {};
        const connections: ConnectionDictionary = {};
      ...
      it('Generates body with child objects loop with v2 logic', () => {
        ...
        connections['source-/ns0:Root/LoopingWithIndex/WeatherReport'].outputs[0].isRepeating = true;
      ...
      it('Generates body with many to many nested loops with v2 logic', () => {
        ...
        connections['source-/ns0:SourceSchemaRoot/Looping/ManyToMany/Simple'].outputs[0].isRepeating = true;
        connections['source-/ns0:SourceSchemaRoot/Looping/ManyToMany/Simple/SourceSimpleChild'].outputs[0].isRepeating = true;
        connections[
          'source-/ns0:SourceSchemaRoot/Looping/ManyToMany/Simple/SourceSimpleChild/SourceSimpleChildChild'
        ].outputs[0].isRepeating = true;
      ...
      it('Generates body with function loop v2', () => {
        const sourceNode = extendedSourceSchema.schemaTreeRoot.children.find((child) => child.name === 'Looping') as SchemaNodeExtended;
        const targetNode = extendedTargetSchema.schemaTreeRoot.children.find((child) => child.name === 'Looping') as SchemaNodeExtended;
        const concatFunctionId = createReactFlowFunctionKey(concatFunction);
        const mapDefinition: MapDefinitionEntry = {};
      ...
      it('Generates body with index and passthrough loop', () => {
        // danielle do we want to support this?
        const sourceNode = extendedSourceSchema.schemaTreeRoot.children.find((child) => child.name === 'Looping') as SchemaNodeExtended;
        const targetNode = extendedTargetSchema.schemaTreeRoot.children.find((child) => child.name === 'Looping') as SchemaNodeExtended;
        const indexFunctionId = createReactFlowFunctionKey(indexPseudoFunction);
        const mapDefinition: MapDefinitionEntry = {};
        ...
        connections['source-/ns0:Root/Looping/Employee'].outputs[0].isRepeating = true;
