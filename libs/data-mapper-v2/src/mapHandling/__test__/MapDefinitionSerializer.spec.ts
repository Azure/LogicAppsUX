...
describe('mapDefinitions/MapDefinitionSerializer', () => {
  describe('XML to XML', () => {
    ...
    describe('generateMapDefinitionBody', () => {
      ...
      it.only('Generates body with two property conditionals', () => {
        ...
        const ifFunctionId1 = createReactFlowFunctionKey(ifPseudoFunction);
        const ifFunctionId2 = createReactFlowFunctionKey(ifPseudoFunction);
        ...
        // Inputs to first conditional
        applyConnectionValue(connections, {
          targetNode: ifPseudoFunction,
          targetNodeReactFlowKey: ifFunctionId1,
          findInputSlot: true,
          input: {
        ...
        // Inputs to second conditional
        applyConnectionValue(connections, {
          targetNode: { ...ifPseudoFunction },
          targetNodeReactFlowKey: ifFunctionId2,
          findInputSlot: true,
          input: {
            reactFlowKey: greaterThanId,
            node: greaterThanFunction,
