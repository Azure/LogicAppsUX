...
export const SelectExistingSchema = (props: SelectExistingSchemaProps) => {
  ...
  const availableSchemaList = useSelector(
    (state: RootState) => state.schema.availableSchemas
  );
  ...
  return (
    ...
    <Tree style={{border: 'solid .5px'}}>
      ...
      <TreeItem itemType="branch">
        <Link style={{textAlign: 'center'}}>Refresh results</Link> 
    </TreeItem>
