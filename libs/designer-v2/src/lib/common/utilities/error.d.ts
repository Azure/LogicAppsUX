 ...
 */
export declare function getMonitoringError(errorRun: {
    error: ErrorRun;
} | ErrorRun | undefined, statusRun: string | undefined, codeRun: string | undefined): ErrorProps;
/**
 ...
 */
export declare const getMonitoringTabError: (errorRun: {
    code: string;
    message: string;
} | undefined, statusRun: string | undefined, codeRun: string | undefined) => {
    code: string;
    message: string;
 ...
 */
export declare const extractErrorInfo: (errorRun: {
    error: ErrorRun;
} | ErrorRun | undefined | string, codeRun: string | undefined) => {
