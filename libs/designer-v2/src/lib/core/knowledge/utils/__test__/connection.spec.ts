  ...
  describe('getConnectionParametersForEdit', () => {
    ...
    it('extracts parameter values from connection metadata using serialization path', () => {
              ...
              metadata: {
                value: {
                  cosmosDB: {
                    ...
                    resourceId: '/subscriptions/sub/resourceGroups/rg/providers/Microsoft.DocumentDB/databaseAccounts/cosmos',
                    authentication: {
                      type: 'Key',
      ...
      expect(result.parameterValues.cosmosDbServiceAccountId).toBe(
        '/subscriptions/sub/resourceGroups/rg/providers/Microsoft.DocumentDB/databaseAccounts/cosmos'
      );
