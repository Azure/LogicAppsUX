...
import { useIsCombineVariableModalOpen, useCloseCombineVariable } from '../../core/state/modal/ModalContext';
...
export const CombineInitializeVariableDialog = () => {
  ...
  const closeCombineVariable = useCloseCombineVariable();
