...
const BUILTIN_MCP_ADD_ICON_URI =
  'data:image/svg+xml,%3Csvg%20fill%3D%22%23242424%22%20aria-hidden%3D%22true%22%20width%3D%2232%22%20height%3D%2232%22%20viewBox%3D%220%200%2032%2032%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M16%203a1%201%200%200%201%201%201v11h11a1%201%200%201%201%200%202H17v11a1%201%200%201%201-2%200V17H4a1%201%200%201%201%200-2h11V4a1%201%200%200%201%201-1Z%22%20fill%3D%22%23242424%22%3E%3C%2Fpath%3E%3C%2Fsvg%3E';
...
export const builtinMcpServerOperation: DiscoveryOperation<BuiltInOperation> = {
  ...
  properties: {
    api: {
      ...
      iconUri: BUILTIN_MCP_ADD_ICON_URI,
    },
