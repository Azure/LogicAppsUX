...
const concurrencyDialogMessage =
  "After you publish, concurrency control can't be turned off. You can change it while the workflow is in draft.";
...
describe('ui/settings/sections/general', () => {
  ...
  it('should lock the trigger concurrency toggle once the enabled setting has been published', async () => {
    const user = userEvent.setup();
    const { props } = renderGeneral({
