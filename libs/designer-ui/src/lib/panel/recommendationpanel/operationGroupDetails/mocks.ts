...
export const mockOperationApi: OperationApi = {
  ...
  description:
    'This is a grouping of operations.  Not much else to say, but I need to fill space.  Kind of awkward but blah blah blah blah blah blah blah blah blah blah blah blah.',
  brandColor: '#770BD6',
  iconUri:
