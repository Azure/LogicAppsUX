import type { OperationGroupDetailsPageProps, OperationActionData } from './operationGroupDetails';
...
export const mockOperationApi: OperationApi = {
  ...
  description: 'This is a grouping of operations.  Not much else to say, but I need to fill space.  Kind of awkward...',
  brandColor: '#770BD6',
  iconUri:
...
export const mockOperationActionsData: OperationActionData[] = [
  {
    ...
    subtitle: 'This is a test operation',
