...
export type SearchResultsGridV2Props = {
...
export const SearchResultsGridV2: React.FC<PropsWithChildren<SearchResultsGridV2Props>> = ({
  isLoadingMore,
  isLoadingSearch,
  searchTerm,
  ...
  const [resultsSorting] = React.useState<SearchResultSortOption>(SearchResultSortOptions.unsorted);
