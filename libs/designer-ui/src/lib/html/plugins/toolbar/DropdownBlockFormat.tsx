...
export const BlockFormatDropDown = ({ editor, blockType, disabled = false }: BlockFormatDropDownProps): JSX.Element => {
  ...
  const TextNames = {
    paragraphText: intl.formatMessage({ defaultMessage: 'Normal', id: 'ms9612ff28b11a', description: 'Normal text' }),
    h1Text: intl.formatMessage({ defaultMessage: 'Heading 1', id: 'ms4ed73448c2db', description: 'Heading 1 text' }),
    h2Text: intl.formatMessage({ defaultMessage: 'Heading 2', id: 'ms4869d3a6dcd0', description: 'Heading 2 text' }),
    h3Text: intl.formatMessage({ defaultMessage: 'Heading 3', id: 'ms3feec6eb6016', description: 'Heading 3 text' }),
    bulletListText: intl.formatMessage({ defaultMessage: 'Bullet list', id: 'msc06f1fc33491', description: 'Bullet List text' }),
    numberListText: intl.formatMessage({ defaultMessage: 'Numbered list', id: 'ms6e0d34798e92', description: 'Numbered List text' }),
  };
