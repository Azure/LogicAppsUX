        ...
        <div className={'msla-flowPreview-root'} data-automation-id={dataAutomationId}>
            {trigger && (
                <>
                    ...
                    <p className={'msla-flowpreview-description'}>
                        {intlText.flowPreviewTriggerDescription}
                    </p>
                    <OperationItem
                        operation={trigger}
                        isAction={false}
            ...
            <p className={'msla-flowpreview-description'}>
                {intlText.flowPreviewActionsDescription}
            </p>
            <OperationsPreview
...
const OperationPreview: React.FC<OperationPreviewProps> = ({
    operationName,
    operation,
    options,
    ...context
        ...
        switch (operation.type) {
            ...
            case Constants.NODE.TYPE.SWITCH:
                ...
                if (operation.default?.actions) {
                    subOperations.push({
                        displayName:
                            intlText.flowPreviewSwitchDefaultLabel,
        ...
        return (
            <div className={'msla-operationPreview-blockContainer'}>
                ...
                {subOperations.length > 0 && (
                    <SubOperationsPreview subOperations={subOperations} options={options} {...context} />
                )}
            </div>
        );
    }
