import TokenPickerHandler from '../editor/base/plugins/TokenPickerHandler';
...
export function TokenPicker({
  ...
  const [updatingExpression, setUpdatingExpression] = useState(false);
