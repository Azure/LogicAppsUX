...
export const AGENT_MODEL_CONFIG: Record<string, { name: string; version: string; format: string }> = {
  'gpt-5.4-nano': { name: 'gpt-5.4-nano', version: '2026-03-17', format: 'OpenAI' },
  'gpt-5.4-mini': { name: 'gpt-5.4-mini', version: '2026-03-17', format: 'OpenAI' },
  'gpt-5.4-pro': { name: 'gpt-5.4-pro', version: '2026-03-05', format: 'OpenAI' },
  'gpt-5.4': { name: 'gpt-5.4', version: '2026-03-05', format: 'OpenAI' },
  'model-router': { name: 'model-router', version: '2025-05-15', format: 'OpenAI' },
  'gpt-5.3-chat': { name: 'gpt-5.3-chat', version: '2026-03-03', format: 'OpenAI' },
  'gpt-5.2-chat': { name: 'gpt-5.2-chat', version: '2026-02-10', format: 'OpenAI' },
  'gpt-5.2': { name: 'gpt-5.2', version: '2025-12-11', format: 'OpenAI' },
  'gpt-5': { name: 'gpt-5', version: '2025-08-07', format: 'OpenAI' },
  'gpt-5-chat': { name: 'gpt-5-chat', version: '2025-08-07', format: 'OpenAI' },
  'gpt-5.1': { name: 'gpt-5.1', version: '2025-11-13', format: 'OpenAI' },
  'gpt-5.1-chat': { name: 'gpt-5.1-chat', version: '2025-11-13', format: 'OpenAI' },
