  ...
  properties: {
    ...
    operations: {
      GetDataSets: {
        ...
        summary: 'Get Available MCP Operations',
        description: 'Retrieve available operations from the MCP server',
        'x-ms-visibility': 'internal',  // Hide this helper operation from users
        responses: {
          '200': {
            description: 'Success',
            schema: {
          ...
          "parameters": {
            "connectionString": {
              ...
              "uiDefinition": {
                ...
                "tooltip": "Provide the connection string for SQL Server.",
                "constraints": {
                  "required": "true"
                },
                "description": "The connection string for SQL Server."
              }
            }
          },
          "uiDefinition": {
          ...
          "parameters": {
            "serverName": {
              ...
              "uiDefinition": {
                ...
                "tooltip": "The SQL server endpoint, for example, <name>.database.windows.net",
                "constraints": {
                  "required": "true"
                },
                "description": "The endpoint for SQL server."
              }
            },
            "databaseName": {
              "type": "string",
            ...
            "Type": {
              ...
              "uiDefinition": {
                ...
                "tooltip": "Active Directory OAuth",
                "constraints": {
                  "required": "true",
                  "default": "ActiveDirectoryOAuth",
                  "hideInUI": "true",
                  "propertyPath": [
                    "authProvider"
                  ]
                },
                "description": "Active Directory OAuth"
              }
            },
            "Authority": {
              "type": "string",
          ...
          "parameters": {
            ...
            "managedIdentityType": {
              ...
              "uiDefinition": {
                ...
                "tooltip": "The type of managed identity",
                "constraints": {
                  "allowedValues": [
                    {
            ...
            "managedIdentityClientId": {
              ...
              "parameterSource": "NotSpecified",
              "uiDefinition": {
                "displayName": "Identity client id",
                "tooltip": "The client id of user identity",
                "constraints": {
                  "required": "true",
                  "dependentParameter": {
                ...
                "description": "The client id of user identity"
              }
            },
            "serverName": {
              "type": "string",
