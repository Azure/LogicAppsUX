...
export class ExpressionParser {
  ...
  public static parseExpression(expression: string, isAliasPathParsingEnabled = false): ParserExpression {
  ...
  public static parseTemplateExpression(expression: string, isAliasPathParsingEnabled = false): ParserExpression {
  ...
  private static _parseExpressionRecursively(scanner: ExpressionScanner, index = 0, isAliasPathParsingEnabled: boolean): ParserExpression {
  ...
  private static _parseFunctionExpression(scanner: ExpressionScanner, isAliasPathParsingEnabled: boolean): ExpressionFunction {
    ...
    const functionArguments: ParserExpression[] = [];
  ...
  private static _parseStringInterpolationExpression(
    ...
    const segments: ParserExpression[] = [];
