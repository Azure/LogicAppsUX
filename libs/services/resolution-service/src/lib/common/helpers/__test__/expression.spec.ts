import { ExpressionType, isStringLiteral, isLiteralExpression, isTemplateExpression, isFunction, isStringInterpolation, isParameterOrAppSettingExpression } from '../expression';
