...
export const AssertionErrorCode = {
  ...
  SERVICE_NOT_INITIALIZED: 'ServiceNotRegistered',
};
export type AssertionErrorCode = (typeof AssertionErrorCode)[keyof typeof AssertionErrorCode];
