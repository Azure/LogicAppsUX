...
import { ConnectionService, OperationManifestService } from '@microsoft/logic-apps-designer';
import type { Connector, LogicAppsV2, OperationInfo, OperationManifest } from '@microsoft/logic-apps-designer';
