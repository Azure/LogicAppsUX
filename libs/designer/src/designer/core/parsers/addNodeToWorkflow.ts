...
import type { DiscoveryOperation, DiscoveryResultTypes, SubgraphType } from '@microsoft/logic-apps-designer';
import { removeIdTag, SUBGRAPH_TYPES, WORKFLOW_EDGE_TYPES, isScopeOperation, WORKFLOW_NODE_TYPES } from '@microsoft/logic-apps-designer';
