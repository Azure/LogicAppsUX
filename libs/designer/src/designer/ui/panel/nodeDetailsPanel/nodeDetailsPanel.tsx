...
import type { CommonPanelProps, MenuItemOption, PageActionTelemetryData } from '@microsoft/logic-apps-designer';
import {
  DeleteNodeModal,
  MenuItemType,
  PanelContainer,
...
import { isNullOrUndefined, isScopeOperation, isSubGraphNode } from '@microsoft/logic-apps-designer';
