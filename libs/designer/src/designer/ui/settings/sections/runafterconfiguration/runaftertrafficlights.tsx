...
import { EmptyTrafficLightDot, TrafficLightDot } from '@microsoft/logic-apps-designer';
import { RUN_AFTER_COLORS, RUN_AFTER_STATUS } from '@microsoft/logic-apps-designer';
