...
import { WorkflowParameterComponent } from '../workflowparameter';
...
describe('ui/workflowparameters/workflowparameter', () => {
  ...
  it('should construct.', () => {
    const parameter = renderer.render(<WorkflowParameterComponent {...minimal} />);
    expect(parameter).toMatchSnapshot();
  });

  it('should render workflow parameter when passed a parameter definition.', () => {
    renderer.render(<WorkflowParameterComponent {...minimal} />);
