...
import type { ConnectionParameter, ConnectionParameterAllowedValue } from '@microsoft/logic-apps-designer';
import { ConnectionParameterTypes } from '@microsoft/logic-apps-designer';
