...
export const addSimpleAgentToolToWorkflow = (toolId: string, agentNode: WorkflowNode, nodesMetadata: NodesMetadata, state: WorkflowState, operation?: DiscoveryOperation<DiscoveryResultTypes>) => {
