...
export class ManifestInputsBinder extends Binder {
  ...
  constructor(
    ...
    this._shouldCreateParametersFromInputs =
      operationType === constants.NODE.TYPE.FOREACH ||
  ...
  async bind(
    ...
    return unmap(inputParameters).reduce(this.makeReducer(operationInputs, this._bindData), {} as BoundParameters);
  }

  private _bindData = (inputs: any, parameter: InputParameter): BoundParameter | undefined => {
