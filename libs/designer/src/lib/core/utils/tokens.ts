...
import type { FunctionDefinition, OutputToken, Token, ValueSegment } from '@microsoft/logic-apps-shared';
import { UIConstants, TemplateFunctions, TokenType } from '@microsoft/logic-apps-shared';
