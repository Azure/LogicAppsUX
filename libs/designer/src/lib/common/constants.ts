...
export default {
    ...
    INT_MAX: 2147483647,
    INT_MIN: -2147483648,
    INTEGRATION_ACCOUNT_ARTIFACT_LOOKUP_ARTIFACT_TYPES: [
        'Schema',
        'Map',
        'Partner',
        'Agreement'
    ...
    TEMPLATE_GALLERY_SUPPORTED_SCHEMA_VERSIONS: [
        SCHEMA.GA_PREVIEW_20160401.VERSION,
        SCHEMA.GA_20160601.VERSION
    ],
    TOKENS: {
        [SWAGGER.TYPE.ANY]: [
            SWAGGER.TYPE.ANY,
    ...
    INCREMENT_VARIABLE_SUPPORTED_TYPES: [
        VARIABLE_TYPE.FLOAT,
