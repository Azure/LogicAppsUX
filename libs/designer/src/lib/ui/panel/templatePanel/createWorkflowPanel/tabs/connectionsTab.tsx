...
export const connectionsTab = (
  ...
  { shouldClearDetails, previousTabId, isCreating, nextTabId, hasError, templateNameLocked }: CreateWorkflowTabProps
): TemplatePanelTab => ({
  ...
  footerContent: {
    ...
    secondaryButtonDisabled: isCreating || (!previousTabId && templateNameLocked),
  },
});
