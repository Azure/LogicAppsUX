...
import { ValueSegmentType, BaseEditor, Scratch } from '@microsoft/designer-ui';
    ...
    return (
      <div>
        <BaseEditor
          ...
          initialValue={[
            { type: ValueSegmentType.LITERAL, value: 'this is a line with\na new line in between' },
            {
            ...
            { type: ValueSegmentType.LITERAL, value: 'tokens\nneed to render properly' },
          ]}
        />
      </div>
    );
