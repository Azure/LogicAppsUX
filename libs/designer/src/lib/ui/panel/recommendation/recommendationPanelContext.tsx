...
const nativeMcpServerOperation = {
...
const nativeMcpServerOperationData: OperationsData = { 
  type: 'Operation',
  data: getOperationCardDataFromOperation(nativeMcpServerOperation)
};
...
export const RecommendationPanelContext = (props: CommonPanelProps) => {
  ...
  const onAddMcpServer = useCallback((id: string, apiId?: string) => {
    if (id === nativeMcpServerOperationData.data.id) {

      dispatch(addOperation({
        operation: nativeMcpServerOperation,
        relationshipIds,
        nodeId: nativeMcpServerOperation.properties.summary.replaceAll(' ', '_'),
      ...
      {
            {
              ...
              [SELECTION_STATES.SEARCH]: (
                <>
                  ...
                  />
                  {/* {isAddingMcpServer && !searchTerm && (
                    <div>
                      <RecommendationPanelCard
                        operationData={nativeMcpServerOperationData}
                        onOperationClick={onAddMcpServer}
                        showFilledFavoriteOnlyOnHover={false}
                        showUnfilledFavoriteOnlyOnHover={false}
                  ...
                  {isAddingMcpServer ? (
                    <SearchView
                      ...
                      isAddingMcpServer={isAddingMcpServer}
                      pinnedOperation={nativeMcpServerOperation}
                    />
                  ) : 
                  searchTerm ? (
                    <SearchView
