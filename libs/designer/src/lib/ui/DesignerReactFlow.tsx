...
import { containsIdTag, guid, removeIdTag, WORKFLOW_NODE_TYPES, SUBGRAPH_TYPES, type WorkflowNodeType } from '@microsoft/logic-apps-shared';
...
const DesignerReactFlow = (props: any) => {
  ...
  const getNodeComponent = useCallback((nodeType: WorkflowNodeType, nodeId?: string) => {
    ...
    if (nodeType === 'SUBGRAPH_NODE' && nodeId) {
      ...
      switch (subgraphType) {
        case SUBGRAPH_TYPES.AGENT_TOOL:
          return OperationNode; // Render simple agent tools as operation nodes
