...
import { ExtensionProperties, PropertyName, Visibility } from '../common/constants';
...
import type { DownloadChunkMetadata, OpenAPIV2, UploadChunkMetadata } from '@microsoft/logic-apps-designer';
import { aggregate, equals, getPropertyValue, map, unmap } from '@microsoft/logic-apps-designer';
