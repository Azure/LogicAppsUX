...
import type { BuiltInOperation, Connector, DiscoveryOperation, SomeKindOfAzureOperationDiscovery } from '@microsoft/logic-apps-designer';
import { ArgumentException, connectorsSearchResultsMock } from '@microsoft/logic-apps-designer';
