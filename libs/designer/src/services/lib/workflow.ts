import type { LogicAppsV2, ManagedIdentity, OpenAPIV2 } from '@microsoft/logic-apps-designer';
import { AssertionErrorCode, AssertionException } from '@microsoft/logic-apps-designer';

export interface WorkflowsCallbackInfo {
  method?: string;
  value: string;
}
...
export interface IWorkflowService {
   ...
   */
  getCallbackUrl(triggerName: string): Promise<WorkflowsCallbackInfo>;
