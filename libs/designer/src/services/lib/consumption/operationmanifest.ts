...
import type { OperationInfo, OperationManifest } from '@microsoft/logic-apps-designer';
import { ArgumentException, UnsupportedException, startsWith } from '@microsoft/logic-apps-designer';
