...
export const convertFromMapDefinition = (
      ...
      self: {
        node: {
          ...
          pathToRoot: [
            ...
            { key: '/ns0:Root/ManyToOne', name: 'ManyToOne', fullName: 'ManyToOne', repeating: false },
            { key: '/ns0:Root/ManyToOne/Year', name: 'Year', fullName: 'Year', repeating: true },
            { key: '/ns0:Root/ManyToOne/Year/Month', name: 'Month', fullName: 'Month', repeating: true },
            { key: '/ns0:Root/ManyToOne/Year/Month/Day', name: 'Day', fullName: 'Day', repeating: true },
            { key: '/ns0:Root/ManyToOne/Year/Month/Day/Date', name: 'Date', fullName: 'Date', repeating: false },
          ],
        },
      ...
      outputs: [
        {
          node: {
            ...
            pathToRoot: [
              { key: '/ns0:Root', name: 'Root', fullName: 'ns0:Root', repeating: false },
              { key: '/ns0:Root/ManyToOne', name: 'ManyToOne', fullName: 'ManyToOne', repeating: false },
              { key: '/ns0:Root/ManyToOne/Date', name: 'Date', fullName: 'Date', repeating: true },
              { key: '/ns0:Root/ManyToOne/Date/DayName', name: 'DayName', fullName: 'DayName', repeating: false },
            ],
          },
  ...
  return test as unknown as ConnectionDictionary;
};
