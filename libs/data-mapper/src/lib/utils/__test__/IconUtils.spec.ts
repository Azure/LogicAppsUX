...
describe('icon utils', () => {
  describe('iconForFunctionCategory', () => {
    it('returns correct icon url for given category', () => {
      ...
      expect(result).toEqual('https://datamappericons.azureedge.net/icons/dm_category_string.svg');
    });
    ...
    it('returns correct icon url if category does not exist on frontend', () => {
      ...
      expect(result).toEqual('https://datamappericons.azureedge.net/icons/dm_category_utility.svg');
    });
  });
});
