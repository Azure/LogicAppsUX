...
const baseURL = `https://raw.githubusercontent.com/divyaswarnkar/LogicAppsTemplates/${releaseBranch}`;
const sourceCodeURL = `https://github.com/divyaswarnkar/LogicAppsTemplates/tree/${releaseBranch}`;
