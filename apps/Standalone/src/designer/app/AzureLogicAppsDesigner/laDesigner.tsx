...
const getConnectionsToUpdate = (
  ...
  if (!hasNewFunctionKeys && !hasNewApimKeys && !hasNewManagedApiKeys && !hasNewServiceProviderKeys && !hasNewAgentKeys && !hasNewMcpConnectionKeys) {
    return undefined;
  }
  ...
  if (hasNewMcpConnectionKeys) {
      ...
      if (originalConnectionsJson.agentMcpConnections?.[agentMcpConnectionName]) {
        (connectionsToUpdate.agentMcpConnections as any)[agentMcpConnectionName] = originalConnectionsJson.agentMcpConnections[agentMcpConnectionName];
      }
    }
  }
