...
const brandColor = '#00208A';

// Export both versions of the connector (with and without leading slash)
export const agentManifestWithSlash = {
  name: 'agent',
  id: 'agent',
  type: 'Agent',
  properties: {
...
export const agentConnectionProviderResponse = {
  name: 'agent',
  id: '/connectionProviders/agent',
  ...
  properties: {
    ...
    runtimeUrls: ['https://logic-apis-northeurope.azure-apim.net/apim/agent'],
    generalInformation: {
      iconUrl: iconUri,
      displayName: 'Agent',
      description: 'Agent operations',
        ...
        parameterSets: {
          oauth2: {
            oAuthSettings: {
              ...
              scopes: [],
              redirectMode: 'Global',
              redirectUrl: 'https://logic-apis-northeurope.azure-apim.net/redirect',
              properties: {
                IsFirstParty: 'True',
              },
              customParameters: {},
