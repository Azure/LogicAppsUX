...
import { loadRun, loadWorkflow, setDarkMode, setMonitoringView, setReadOnly } from '../state/workflowLoadingSlice';
...
const ContextSettings = () => {
  ...
  return (
    <div style={{ display: 'flex', gap: '24px' }}>
      ...
      />
      <Checkbox label="Is Monitoring View" checked={monitoringView} onChange={changeMonitoringView} />
