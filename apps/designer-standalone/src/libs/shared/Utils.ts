 ...
 */
export function arrayEquals<T extends Primitive>(a: (T | undefined)[] | null | undefined, b: (T | undefined)[] | null | undefined): boolean {
    if (!a || !b) {
        return a === b;
    }
 ...
 */
export function arrayEqualsOrderInsensitive<T extends Primitive>(a: (T | undefined)[] | null | undefined, b: (T | undefined)[] | null | undefined): boolean {
    if (!a || !b) {
        return a === b;
    }
...
export function getPropertyValue(object: Object | null | undefined, propertyName: string, caseInsensitive = true): any {
    ...
    const value = (<any>object)[propertyName]; // tslint:disable-line: no-any
    if (value !== undefined) {
        return value;
    }
    ...
    for (const key of Object.keys(object)) {
        if (equals(key, propertyName, caseInsensitive)) {
            return (<any>object)[key]; // tslint:disable-line: no-any
        }
    }
...
export function setObjectPropertyValue(object: Object, properties: string[], value: any): void {
    ...
    if (lastProperty) {
        (<any>object)[lastProperty] = value; // tslint:disable-line: no-any
    }
}
...
export function safeSetObjectPropertyValue(target: Record<string, any> | null | undefined, properties: string[], value: any): Record<string, any> | null | undefined {
...
export function deleteObjectProperty(object: Object, properties: string[]): void {
    ...
    const lastProperty = properties[properties.length - 1];
    if (lastProperty) {
        delete (<any>object)[lastProperty]; // tslint:disable-line: no-any
    }
}
...
export function unmap<T>(object: Record<string, T> | null | undefined, keyName?: string): T[] {
    ...
    return Object.keys(obj).map(key => {
        ...
        if (keyName) {
            (<any>element)[keyName] = key; // tslint:disable-line: no-any
        }
...
export function combineObjects(originalObjects: Record<string, any>, newObjects: Record<string, any>): Record<string, any> {
    // tslint:disable-line: no-any
    return Object.keys(newObjects).reduce((previous, current) => extend({}, previous, { [current]: newObjects[current] }), clone(originalObjects));
}
 ...
 */
export function deepCompareObjects(object1: Record<string, any>, object2: Record<string, any>): boolean {
    // tslint:disable-line: no-any
 ...
 */
export function findAncestorElement(startingElement: HTMLElement, predicateFunction: (currentElement: HTMLElement) => boolean): HTMLElement | undefined {
