...
export const dataMapSlice = createSlice({
  ...
  reducers: {
    ...
    changeIsTestEnabledForOS: (state, action: PayloadAction<boolean>) => {
      state.isTestEnabledForOS = action.payload;
    },
  },
});
