...
**[Link to access legacy designer](https://portal.azure.com/?microsoft_azure_ema_forceFallbackToOldDesigner=true#view)**
...
1. Open the developer tools in your browser with the keyboard shortcut `Ctrl+Shift+I`
...
### Finding your portal version

To get the currently active portal version follow these steps:

1. Navigate to a workflow
2. Open the Azure monitoring tools with `Ctrl+Alt+D`
3. In the bottom right of the designer there should be a yellow box
4. Find the line `Loaded extensions:` and click on `Details`
5. You will find the currently active designer version next to the line that says `Microsoft_Azure_EMA:`
