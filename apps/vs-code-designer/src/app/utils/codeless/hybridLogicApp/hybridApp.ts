...
export const createHybridApp = async (context: IActionContext, accessToken: string, options: createHybridAppOptions) => {
  ...
  const url = `https://management.azure.com/subscriptions/${subscriptionId}/resourceGroups/${resourceGroup}/providers/Microsoft.App/containerApps/${siteName}?api-version=2024-02-02-preview`;
