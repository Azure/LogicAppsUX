...
export async function isJavaProject(projectPath: string): Promise<boolean> {
...
export async function isFSharpProject(context: IActionContext, projectPath: string): Promise<boolean> {
