...
import { ProjectResource, Artifacts, Parameter, IWorkflowFileContent, ServiceProviderConnectionModel } from '@microsoft-logic-apps/utils';
...
import { RemoteWorkflowsTreeItem } from './RemoteWorkflowsTreeItem';
...
function getThemedIconPath(arg0: string): TreeItemIconPath {
