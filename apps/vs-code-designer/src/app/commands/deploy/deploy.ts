...
import { logicAppFilter, webhookRedirectHostUri } from '../../../constants';
...
import { getDeployFsPath, getDeployNode } from '@microsoft/vscode-azext-azureappservice';
...
async function deploy(
  ...
  const { originalDeployFsPath, effectiveDeployFsPath } = deployPaths;
  ...
  const isDeployingToFileShare = true;
  ...
  // if (getWorkspaceSetting<boolean>(showDeployConfirmationSetting, workspaceFolder.uri.fsPath) && !context.isNewApp) {
