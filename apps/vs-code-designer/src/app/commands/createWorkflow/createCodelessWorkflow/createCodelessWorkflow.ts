...
import { WorkflowKindStep } from './createCodelessWorkflowSteps/workflowKindStep';
...
// TODO(aeldridge): This command isn't currently exposed, do we need explicit createCodelessWorkflow/createCodefulWorkflow commands?
export async function createCodelessWorkflow(
  ...
  const wizard: AzureWizard<IFunctionWizardContext> = new AzureWizard(wizardContext, {
    promptSteps: [await WorkflowKindStep.create(wizardContext, { templateId, triggerSettings, isProjectWizard: false })],
  });
