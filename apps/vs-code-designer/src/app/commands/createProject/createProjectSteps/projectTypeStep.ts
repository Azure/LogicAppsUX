...
export class ProjectTypeStep extends AzureWizardPromptStep<IProjectWizardContext> {
  ...
  private readonly isImportedProject: boolean;
   ...
   * @param isImportedProject - Indicates whether the project is imported (cloud to local).
   */
  private constructor(
    ...
    this.isImportedProject = isImportedProject;
  }
