...
import { localSettingsFileName, workflowTenantIdKey,  } from '../../../constants';
...
import { getWebViewHTML, getWebViewHTMLFromUrl } from '../../utils/codeless/getWebViewHTML';
...
export async function openChat(context: IAzureConnectorsContext, node: vscode.Uri | RemoteWorkflowTreeItem | undefined): Promise<void> {
  ...
  panel.webview.html = await getWebViewHTMLFromUrl(baseUrl, panel);
