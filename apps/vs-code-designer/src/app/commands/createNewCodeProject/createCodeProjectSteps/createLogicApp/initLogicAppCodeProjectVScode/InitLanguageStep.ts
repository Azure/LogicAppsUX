...
import { WorkflowInitCodeProject } from './WorkflowProject';
...
export class InitVSCodeLanguageStepCodeProject extends AzureWizardPromptStep<IProjectWizardContext> {
...
export async function addInitVSCodeStepsCodeProject(
