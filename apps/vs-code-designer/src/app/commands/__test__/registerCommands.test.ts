...
vi.mock('../createProject/createProject', () => ({ createNewProject: vi.fn() }));
...
vi.mock('../parameterizeConnections', () => ({ parameterizeAllConnections: vi.fn(), parameterizeProjectConnections: vi.fn() }));
vi.mock('../../utils/managedIdentity', () => ({ enableLocalManagedIdentityAuth: vi.fn() }));
