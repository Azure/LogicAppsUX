...
export const draftWorkflowFileName = 'workflow.draft.json';
export const draftConnectionsFileName = 'connections.draft.json';
export const draftParametersFileName = 'parameters.draft.json';
