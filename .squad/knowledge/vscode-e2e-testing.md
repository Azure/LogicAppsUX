...
- Current manifest-backed scenarios:
  ...
  | `p415-projectoverview` | Standard Stateful `.code-workspace` |
  | `p415-codeful-projectoverview` | Codeful Stateful `.code-workspace`; source-based workflow generated by the real Create Workspace wizard |
