...
export abstract class BaseComponent<P extends BaseComponentProps, S = {}> extends React.Component<P, S> {
    ...
    protected getTelemetryContext(): Record<string, any> {  // tslint:disable-line: no-any
        return {
    ...
    protected trackAction(action: UserAction, telemetryIdentifier: string, additionalTelemetryContext?: Record<string, any>): void { // tslint:disable-line: no-any
